 ...
 */
export declare const TileFavoriteIconMUI: ({ isFavorite, onAddToFavorites, onRemoveFromFavorites, addLabel, removeLabel, disabled, className, sx, }: TileFavoriteIconProps) => React.JSX.Element;
