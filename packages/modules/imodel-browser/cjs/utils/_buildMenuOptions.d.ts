 ...
 * @alpha
 */
export interface ContextMenuBuilderItemMUI<T = any> extends Omit<MuiMenuItemProps, "onClick" | "value" | "disabled" | "children"> {
    sourceAppId?: string;
    key: string;
 ...
 * @private
 */
export declare const buildContextMenuItemsMUI: <T>(options: ContextMenuBuilderItemMUI<T>[] | undefined, value: T, closeMenu?: () => void, refetchData?: () => void) => JSX.Element[] | undefined;
export {};
