...
export type ITwinSubClass = "Project" | "Asset" | "Portfolio" | "Program" | "WorkPackage" | "All";
export type ITwinClassType = "Thing" | "Endeavor";
export type ITwinStatus = "Active" | "Inactive" | "Trial" | "active" | "inactive" | "trial";
export type ViewType = "tile" | "cells";
export type IModelViewType = ViewType;
export declare enum IModelCellColumn {
    Favorite = "Favorite",
    Name = "name",
